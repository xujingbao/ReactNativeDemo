...
SliderAntm=function(_React$Component){(0,_inherits3["default"])(SliderAntm,_React$Component);function SliderAntm(){(0,_classCallCheck3["default"])(this,SliderAntm);return(0,_possibleConstructorReturn3["default"])(this,_React$Component.apply(this,arguments));}SliderAntm.prototype.
render=function render(){var _props=
this.props,defaultValue=_props.defaultValue,value=_props.value,min=_props.min,max=_props.max,step=_props.step,disabled=_props.disabled,onChange=_props.onChange,onAfterChange=_props.onAfterChange,maximumTrackTintColor=_props.maximumTrackTintColor,minimumTrackTintColor=_props.minimumTrackTintColor;
...
};return SliderAntm;}(_react2["default"].Component);exports["default"]=SliderAntm;
...
defaultValue:0,
disabled:false,
maximumTrackTintColor:_reactNative.StyleSheet.flatten(_style2["default"].maximum).color,
minimumTrackTintColor:_reactNative.StyleSheet.flatten(_style2["default"].minimum).color};module.exports=exports['default'];